 ...
 *
 * (c) 2006,2007 Christoph Griep
 * 
 */

/**
  * Berechnet die Stunden, die von einer Verhinderung betroffen sind.
  * Es werden nur unbearbeitete Stunden angezeigt.
...
{ 
  ...
  foreach ( $betroffene as $Tag => $Klassen )
  {
    ...
    $betroffen .= '<a href="';
    $betroffen .= '/Vertretung/VertretungPlanen.php?Verhinderung_id='.$eintrag['Verhinderung_id'].'&Datum='.$Tag;
