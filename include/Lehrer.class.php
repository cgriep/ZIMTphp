...
/**
 * Klasse Lehrer
 * Kapselt die Funktionalitäten für die Bestimmung des Lehrernamens, des 
 * Kürzels und des Benutzernamens auf dem WebServer
 */
...
/**
   * Sucht zu einem Benutzernamen/einer E-Mail das passende Kürzel des Kollegen.
   * @param $user Der Benutzername 
   * @return das Kürzel des Kollegen bzw. eine leere Zeichenkette im Fehlerfalle
   */
  ...
  /**
   * Sucht zu einem Kürzel den passenden User / E-Mail-Namen
  ...
  /**
   *  Sucht den Namen und Vornamen eines Lehrers zu einem Kürzel
   *  Wenn das Kürzel unbekannt ist, wird als Name das Kürzel, als Vorname 
